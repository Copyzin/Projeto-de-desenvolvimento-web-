...
const RegisterLesson = lazy(() => import("@/pages/register-lesson"));
    ...
    <Suspense fallback={<RouteFallback />}>
      ...
      {isAuthFlowRoute ? (
        ...
        <Switch>
          ...
          <Route
            path="/schedule"
            component={() => <ProtectedRoute component={Schedule} allowedRoles={["teacher", "student"]} />}
          />
          <Route
            path="/register-lesson"
            component={() => <ProtectedRoute component={RegisterLesson} allowedRoles={["teacher"]} />}
          />
