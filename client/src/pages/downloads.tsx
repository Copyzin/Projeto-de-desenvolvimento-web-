  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Downloads reais por curso/turma com permissao, fixacao pessoal e reorganizacao local."
      />
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {isLoading ? (
            ...
            <EmptyState message="Nenhum material disponivel para o filtro selecionado." />
          ) : (
            <div className="space-y-2">
